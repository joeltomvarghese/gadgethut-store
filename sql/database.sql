-- Create database
CREATE DATABASE IF NOT EXISTS gadgethut_store;
USE gadgethut_store;
...
('DSLR Camera Bundle', 'Professional DSLR camera with 24MP sensor, kit lens, tripod, and camera bag.', 799.99, 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=400&h=300&fit=crop', 'Very Good', '1 year', 'Well-maintained equipment. Shutter count: 5,200. Great for beginners.', 4.3, 4),
('Tablet Android 12', '10.5" Android tablet with 128GB storage, stylus support, and keyboard cover.', 349.99, 'https://images.unsplash.com/photo-1558618666-fcd25856cd63?w=400&h=300&fit=crop', 'Excellent', '5 months', 'Minor scratches on back. Screen perfect. Includes original accessories.', 4.1, 9);
