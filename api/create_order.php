    ...
    try {
        ...
        // Check if the connection function exists *after* including the file
        ...
        if (!$pdo) {
             // getDbConnection now returns null on failure
            throw new Exception('Database connection failed. Check config/db.php credentials and MySQL server status.');
        }
